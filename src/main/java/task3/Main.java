...
public class Main {
    ...
    public static void main(String[] args) {
        replaceKeyWithValue(createNonConvertedMap(5));
    }

    public static <K, V> Map<? extends K, ? extends V> createNonConvertedMap(int numberOfSets) {
    ...
    public static <K, V> Map<V, Collection<K>> replaceKeyWithValue(
